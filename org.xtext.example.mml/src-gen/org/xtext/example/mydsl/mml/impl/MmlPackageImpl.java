...
public class MmlPackageImpl extends EPackageImpl implements MmlPackage
{
   ...
   * @generated
   */
  public EAttribute getXFormula_Name()
  {
    return (EAttribute)xFormulaEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EAttribute getTrainingTest_Name()
  {
  ...
  {
    return (EAttribute)trainingTestEClass.getEStructuralFeatures().get(1);
  }
  ...
  public void createPackageContents()
  {
    ...
    createEAttribute(xFormulaEClass, XFORMULA__NAME);
    ...
    createEAttribute(trainingTestEClass, TRAINING_TEST__NAME);
  ...
  public void initializePackageContents()
  {
    ...
    initEAttribute(getMLAlgorithm_Name(), ecorePackage.getEString(), "name", null, 0, 1, MLAlgorithm.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getXFormula_Name(), ecorePackage.getEString(), "name", null, 0, 1, XFormula.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEAttribute(getTrainingTest_Name(), ecorePackage.getEString(), "name", null, 0, 1, TrainingTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getTrainingTest_Number(), ecorePackage.getEString(), "number", null, 0, 1, TrainingTest.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
